// UsuariosSRV4/Data/ApplicationDbContext.cs
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                // ✅ Solo usar CONTRASENA (texto plano)
                entity.Property(e => e.Contrasena).HasColumnName("CONTRASENA").IsRequired().HasMaxLength(100);

                entity.Property(e => e.TipoIdentificacionId).HasColumnName("TIPO_IDENTIFICACION_ID");
                entity.Property(e => e.NumeroIdentificacion).HasColumnName("NUMERO_IDENTIFICACION").IsRequired().HasMaxLength(50);
